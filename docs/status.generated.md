...
- `DEV-06` STT 표본 보관·삭제 운영 · P0 ← **막은 결정** PD-04 음성 보관
- `DEV-08` MY 누적 학습 요약 · P1
- `DEV-09` 법률 링크와 동의 증거 · P0 ← **막은 결정** PD-07 법률·사업자 정보
- `DEV-11` 계정 데이터 열람·내보내기와 가입 연령 · P0 ← **막은 결정** PD-08 가입 가능 연령 · PD-10 개인정보 열람·내보내기
...
- `PD-08` 가입 가능 연령 → DEV-11
- `PD-09` B2C 판매 권리 → DEV-04
- `PD-10` 개인정보 열람·내보내기 → DEV-11
- `PD-11` 다섯 탭 루트 제목 규칙 → 없음(정본 문구)
- `PD-12` 게임 팔레트 → 없음(`check:css`)
- `PD-13` 정본 승인을 안 거친 6화면 → 없음 — **대조가 이미 이 여섯을 지키고 있다.** 그래서 막히지 않고 조용히 굳는다
