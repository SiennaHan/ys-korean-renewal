...
# 300dpi 로 뽑았더니 어휘 아이콘 삽화(인쇄 1~1.5인치 정사각)가 234~450px 대로만
# 나왔다 — 화면 표시 칸(단어 퀴즈 228px)을 레티나(2~3배) 폰에서 채우려면
# 456~684px 가 필요한데 원본 자체가 못 미쳤다. 600dpi 로 올려 그 여유를 만든다
# (2026-09-05, 화질 저하 진단 후 재추출).
DPI = 600
