			...
			{gameState === "level-select" && (
				...
				>
					...
					>
						...
						>
							<span className="ux-title">어휘 카드 마스터</span>
						</div>
					</div>
					...
					<div className="cs-config-panel">
						...
						{/* 과 선택 */}
						<div className="cs-lesson-section" style={{ flex: 1 }}>
							<div
								className="cs-section-label"
								style={{ fontSize: 12, color: "#7878A0", marginBottom: 8 }}
							>
								...
								{Array.from({ length: 5 }, (_, i) => (
									<span
										...
										style={{
											...
											filter:
												i < stats.hp ? "drop-shadow(0 0 4px #FF4060)" : "none",
						...
						{activeCategories.map((cat) => {
							...
							return (
								<button
									...
									onClick={(e) => {
										if (e.detail === 0) handleAnswer(cat);
									}}
									style={{
										padding: "14px 4px",
										borderRadius: 12,
					...
					<div className="cs-result-panel">
						...
						>
							{[
								...
								>
									<span style={{ fontSize: 14, color: "#7878A0" }}>
										{label}
									</span>
									<span
										style={{
