...
export function MicPermissionProvider({ children }: { children: React.ReactNode }) {
...
export function useMicPermission() {
  ...
  if (!ctx) throw new Error("useMicPermission must be used within MicPermissionProvider");
  return ctx;
}
