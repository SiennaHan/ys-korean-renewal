...
export const Route = createFileRoute("/book/chapter/unit/dialog/report/$id")({
...
function ReportComponent() {
	...
	const retryDialog = async () => {
		...
		const res = await resetDialog(dialogId);
		navigate({ to: `/book/chapter/unit/dialog/${dialogId}` });
