const vi = {
	...
	game: {
		...
		springPicnic: {
			...
			scorePct: "Tỉ lệ điểm",
			wrongHead: "Sổ lỗi sai",
			wrongCount: "{{n}}",
			wrongTwice: "Sai hai lần",
			otherMission: "Nhiệm vụ khác 🌸",
			reset: "Xóa dữ liệu đã lưu",
			resetConfirm: "Xóa dữ liệu đã lưu?",
			loading: "Đang tải...",
		...
		list: {
			...
			particleSniper: {
				name: "Thợ bắn trợ từ",
				description: "Đoán nhanh trợ từ đúng",
			},
		},
	},
	/** 하단 탭 바 */
	...
	player: {
		...
		chapterUnit: "Bài {{seq}} - {{title}}",
		chapterActivity: "Bài {{seq}} · {{title}}",
	},
	...
	report: {
		...
		emptyPronunciation: "Không có dữ liệu phát âm để đánh giá.",
		emptyGrammar: "Không có dữ liệu ngữ pháp để đánh giá.",
		emptyContent: "Không có dữ liệu nội dung để đánh giá.",
		emptyVocabulary: "Không có dữ liệu từ vựng để đánh giá.",
	},
	missionChat: {
		completeTitle:
	...
	flashResult: {
		titlePerfect: "Bạn đã thuộc hết từ!",
		titleDone: "Bạn đã học xong lượt này",
		bodyPerfect: "Bạn biết tất cả từ trong bộ này.",
		bodyPartial: "Bạn có thể gom các từ chưa biết để luyện lại.",
		unknownWords: "Từ chưa biết",
		knownWords: "Từ đã biết",
		knowRate: "Đã biết",
		tapNumbersHint: "Chạm vào con số để xem danh sách từ đã biết và chưa biết.",
		retryUnknown: "Luyện lại từ chưa biết",
		finish: "Kết thúc bài học",
	},
	app: {
		updatingTitle: "Ứng dụng đang cập nhật",
		updatingBody:
