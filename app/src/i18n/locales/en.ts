const en = {
	...
	signup: {
		...
		carryBody:
			"What you answered while browsing moves to this account. You won't have to do it again.",
		email: "Email",
		emailHint: "If you forget your password, we'll send a reset link here",
		password: "Password",
	...
	mypage: {
		...
		withdraw: {
			...
			lead: "Here is what happens when you leave.",
			lossAccount: "You can no longer use this account — sign-in is blocked",
			lossName: "Your name and email are erased, and cannot be restored",
			keptRecords:
				"Your learning records stay, no longer tied to your name — answers, progress, AI conversations, voice recordings",
			keptSchool: "Your school can no longer see you",
			irreversible:
				"This cannot be undone. You can sign up again with the same email, but the records that stay will not carry over to the new account.",
			next: "Next",
			confirmLead: "Enter your password once more to leave.",
			password: "Password",
			passwordPlaceholder: "Enter your password",
			showPassword: "Show password",
			hidePassword: "Hide password",
		...
		profileInfo: {
			...
			notice: "Notice",
			noticeText:
				"Profile information can only be changed once per month. The email address cannot be changed.",
	...
	game: {
		...
		seoulPuzzle: {
			brand: "Seoul trip",
			myTrip: "{{name}}'s Seoul trip 🗺️",
			progress: "{{done}} / {{total}} places done",
			review: "Review →",
			canTry: "Open",
			locked: "Locked",
			bookUnit: "Yonsei Book 1 · {{unit}}",
			toMap: "← Map",
			toLocInfo: "← Place info",
			willLearn: "Grammar you'll learn here",
			start: "Start →",
			nthPlace: "Place {{n}} — {{name}}",
			streak: "🔥{{n}} in a row",
			friendInitial: "F",
			makeSentence: "Build the sentence",
			dropHere: "Tap a card to place it here",
			good: "Well done! 👍",
			checkAgain: "Take another look",
			clickInOrder: "Tap them in order",
			hint: "Hint ({{n}})",
			check: "Check",
			...
			goOn: "Continue →",
			xpToast: "⭐ +{{xp}} XP!",
			xpToastStreak: "⭐ +{{xp}} XP! 🔥{{n}} in a row",
			placeDone: "{{name}} complete!",
			allDone: "You finished every sentence!",
			correct: "Correct",
			hintsUsed: "Hints used",
			totalXp: "Total XP",
			learned: "Grammar you learned here",
			backToMap: "Back to the map →",
			welcome1: "Welcome to your",
			welcome2: "Seoul trip!",
			intro1: "Travel through Seoul in Korean",
			intro2: "and pick up new expressions.",
			nameLabel: "Name (Korean or English)",
			namePlaceholder: "e.g. 유리, Emily…",
			startTrip: "Start the trip →",
			nameNote: "Your name is used in the game's dialogue.",
			aria: "Seoul Travel Puzzle",
		},
		/**
	...
	player: {
		...
		chapterUnit: "Lesson {{seq}} - {{title}}",
		chapterActivity: "Lesson {{seq}} · {{title}}",
	},
	...
	report: {
		...
		emptyPronunciation: "There's no pronunciation data to evaluate.",
		emptyGrammar: "There's no grammar data to evaluate.",
		emptyContent: "There's no content data to evaluate.",
		emptyVocabulary: "There's no vocabulary data to evaluate.",
	},
	missionChat: {
		completeTitle:
	...
	flashResult: {
		titlePerfect: "You learned every word!",
		titleDone: "You finished this session",
		bodyPerfect: "You know every word in this set.",
		bodyPartial: "You can gather the words you missed and practice again.",
		unknownWords: "Don't know",
		knownWords: "Know",
		knowRate: "Known",
		tapNumbersHint:
			"Tap a number to see the list of words you know and don't know.",
		retryUnknown: "Practice what you missed",
		finish: "Finish",
	},
	app: {
		updatingTitle: "The app is updating",
		updatingBody:
