const zh = {
	...
	paywall: {
		...
		priceBody: "按月计费。价格尚未确定。",
		restore: "我已经订阅了",
		guestTitle: "请先登录",
		guestBody:
			"登录后学习记录会保存到账号。已经做过的内容会一并带过来 — 不需要重做。",
		guestCta: "登录 / 注册",
		guestBack: "继续免费浏览",
		...
		expiredTitle: "订阅已结束",
		expiredBody:
			"学习记录仍然保留。再次订阅会从停下的地方继续 — 不会从头开始。",
		expiredCta: "重新订阅",
		schoolTitle: "不在学校签约的范围内",
		schoolBody: "当前账号属于学校。如需扩大范围，请联系学校。",
		schoolNote: "个人订阅不能用于机构账号",
		schoolBack: "回到免费课程",
	},
	nav: {
		home: "首页",
